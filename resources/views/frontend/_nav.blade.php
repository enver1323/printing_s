<div class="fixed-top">
    <div class="top-bar d-flex">
        <div class="my-auto d-block d-lg-none w-100">
            <a href="#contactUsNavBarModal" class="text-white" data-toggle="modal">
                <i class="fa fa-phone"></i>
                {{__('frontend.contactUs')}}
            </a>
            @push('modals')
                <div class="modal fade" id="contactUsNavBarModal" role="dialog"
                     aria-labelledby="contactUsNavBarModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="contactUsNavBarModalLabel">{{__('frontend.contactUs')}}</h5>
                            ...
                            <div class="list-group">
                                <a class="list-group-item list-group-item-action"
                                   href="{{route('contacts')}}">{{__('frontend.contacts')}}
                ...
                <div class="top-bar-socials d-none d-lg-flex">
                    <a href="tel:998712565354" target="_blank">
                ...
                <div class="align-content-center d-none d-lg-flex">
                    ...
                    <form class="form-inline ml-auto" action="{{route('results')}}">
                        <div class="md-form form-sm my-0">
                            <input class="text-white" type="text" placeholder="Search" aria-label="Search"
                                   name="search">
                        </div>
        ...
        <nav class="navbar navbar-expand-xl navbar-dark top-bar top-nav-collapse">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                ...
                <ul class="navbar-nav ml-auto d-flex">
                    @if(count($offers))
                        <li class="nav-item my-auto {{request()->routeIs('offers.*') ? 'active' : ''}}">
                            <a class="nav-link" href="{{route('offers.index')}}">{{__('frontend.offers')}}
                                <span class="sr-only">(current)</span>
                            </a>
                        </li>
                    @endif
