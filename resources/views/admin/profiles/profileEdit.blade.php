<div class="card shadow">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input name="profile[family_name]" type="text" id="surname" value="{{ $profile->family_name }}"
        ...
        <div class="form-group">
            ...
            <input name="profile[nickname]" type="text" id="nickname" value="{{ $profile->nickname }}"
        ...
        <div class="form-group">
            ...
            <input name="profile[birth_date]" type="text" id="birthDate" data_value="{{ $profile->birth_date }}"
        ...
        <div class="form-group">
            ...
            <input name="profile[photo]" type="file" id="photo" accept="image/*"
